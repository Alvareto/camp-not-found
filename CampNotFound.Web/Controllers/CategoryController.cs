...
namespace CampNotFound.Web.Controllers
{
    public class CategoryController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,CreatedBy,LastModifiedBy,CreatedDate,LastModifiedDate,Name")] Category category)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,CreatedBy,LastModifiedBy,CreatedDate,LastModifiedDate,Name")] Category category)
        {
            if (ModelState.IsValid)
            {
